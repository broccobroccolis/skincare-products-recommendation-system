...
def featuresDistribution(df):
    ...
    for x in range(0, len(features)):
        if features[x] == "Skin Tone":
            ...
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/skintone_dis.png'),width=450)
        elif features[x] == "Skin Type":
            st.caption("Skin Type: ")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/skintype_dis.png'),width=450)
        elif features[x] == "Eye Color":
            st.caption("Eye Color: ")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/eyecolor_dis.png'),width=450)
        elif features[x] == "Hair Color":
            st.caption("Hair Color: ")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/haircolor_dis.png'),width=450)
...
def ingredientsWordCloud():
    ...
    for x in range(0,len(category)):
        ...
        if category[x] == 'Cleanser':
            st.caption("Cleanser:")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/cleanser_wordcloud.png'),width=450)
        elif category[x] == 'Toner':
            st.caption("Toner:")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/toner_wordcloud.png'),width=450)
        elif category[x] == 'Treatment':
            st.caption("Treatment:")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/treatment_wordcloud.png'),width=450)
        elif category[x] == 'Moisturizer':
            st.caption("Moisturizer:")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/moisturizer_wordcloud.png'),width=450)
        elif category[x] == 'Face Mask':
            st.caption("Face Mask:")
            st.image(Image.open('/Users/wanwoeichyi/Desktop/WIH3001 DS fyp/img/facemask_wordcloud.png'),width=450)
